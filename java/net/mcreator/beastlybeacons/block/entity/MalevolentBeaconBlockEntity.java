...
public class MalevolentBeaconBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(16, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public MalevolentBeaconBlockEntity(BlockPos position, BlockState state) {
		super(BeastlyBeaconsModBlockEntities.MALEVOLENT_BEACON.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("malevolent_beacon");
	}
