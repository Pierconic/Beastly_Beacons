...
public class MidLayerDeactivationProcedure {
		...
		for (int index0 = 0; index0 < 5; index0++) {
			...
			for (int index1 = 0; index1 < 5; index1++) {
				if ((world.getBlockState(BlockPos.containing(x + sx, y - 2, z + sz))).getBlock() == BeastlyBeaconsModBlocks.ACTIVATED_COPPER.get()
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.COPPER_BLOCK.defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.IRON_BLOCK.defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.GOLD_BLOCK.defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.EMERALD_BLOCK.defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.DIAMOND_BLOCK.defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.LAPIS_BLOCK.defaultBlockState(), 3);
					...
					world.setBlock(BlockPos.containing(x + sx, y - 2, z + sz), Blocks.NETHERITE_BLOCK.defaultBlockState(), 3);
				}
				sz = sz + 1;
			}
			sx = sx + 1;
